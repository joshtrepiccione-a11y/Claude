  ...
  return (
    ...
    >
      <div className="space-y-3 text-sm">
        ...
        <div className="text-xs uppercase tracking-wide text-slate-500">County Clerk race</div>
        <div className="grid grid-cols-2 gap-3">
          <Box label="Baseline margin" value={fmtMargin(row.baselineMarginPct)} />
          <Box label="Scenario margin" value={fmtMargin(row.scenarioMarginPct)} />
        ...
        <div>
          ...
          <CandidateRow label={C("clerkD")!.label} v={p.d} party="D" />
          <CandidateRow label={C("clerkR")!.label} v={p.r} party="R" />
        </div>
        ...
        <div>
          ...
          <CandidateRow label={C("clerkD")!.label} v={s.d} party="D" />
          <CandidateRow label={C("clerkR")!.label} v={s.r} party="R" />
        </div>
